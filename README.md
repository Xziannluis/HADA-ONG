...
- The current upload limits are 10 MB for pictures and 2 GB for videos. Run `increase-upload-limit.sql` in Supabase if your existing bucket is still set lower.
